...
class FontBar(tk.Tk):
    ...
    def font_config(self):
        ...
        self.font_tuple = tk.font.families()  # contains all font families names
        self.font_family = (
            tk.StringVar()
        ...
        self.fontbox["values"] = self.font_tuple
        self.fontbox.current(self.font_tuple.index(["Arial"]))
        self.fontbox.grid(row=0, column=0)
        # font box ends here

        # font size box
        self.size = tk.IntVar(self.toolbar)
        self.fontsize= ttk.Spinbox(self.toolbar, width=14, from_=2, to=120,  increment=1, textvariable=self.size)
        ...
        self.fontsize.bind("<<ButtonRealase-1>>", lambda event : self.change_font_size)
        self.fontbox.bind("<ButtonRelease-1>", lambda event : self.change_font)

        self.sel_font_btn = tk.Button(self.toolbar, text=" Set Font", bd=3, bg="blue violet")
        self.sel_font_btn.grid(row=1, column=0)
        self.sel_font_btn2 = tk.Button(self.toolbar,text="set size Font",bd=3,bg="blue violet",command=lambda : self.change_font_size(self.fontsize.get()))
        self.sel_font_btn2.grid(row=1, column=1)
        self.color_btn= tk.Button(self.toolbar, text="Font color", bd=3, bg="goldenrod", command= lambda: self.change_font_color())
    ...
    def change_font(self,event=None):
        ...
        self.fontsize.bind("<ButtonRelease-1>", lambda event : self.change_font_size())
        self.fontbox.bind("<<ComboboxSelected>>",lambda event : self.change_font())
    ...
    def change_font_size(self,event=None):
        ...
        self.text.configure(font=(self.fontbox,get(), self.fontsize.get()))
    ...
    """def change_bold(event=None):
         ...
         if text_property.actual()['weight'] == "normal":
             text.configure(font = 
(current_font_family,self.current_font_size, "bold"))
         if text_property.actual()["weight"] == "bold":
             text.configure(font = 
(current_font_family,self.current_font_size, "normal"))"""
